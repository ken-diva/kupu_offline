...
def convert_to_png(path, pos):
    ...
    for d in data:
        ...
        decoded_rle = np.reshape(decode_rle(d["value"]["rle"]), [height, width, 4])[
            :, :, 3
        ]
        ...
        elif img_name == "R_Clavicle" or img_name == "L_Clavicle":
            r, g, b, a = 109, 21, 193, 190
        elif img_name == "Ribs":
            r, g, b, a = 228, 70, 206, 190
        elif img_name == "R_Scapula" or img_name == "L_Scapula":
            r, g, b, a = 224, 131, 46, 190
        elif img_name == "Sternum":
            r, g, b, a = 129, 64, 4, 190
        elif img_name == "R_Humerus" or img_name == "L_Humerus":
        ...
        elif img_name == "R_Femur" or img_name == "L_Femur":
